...
<div class="flex-1 bg-blue-100 p-6">
     ...
     <div class="w-full">
        ...
        <a class="bg-green-500 text-white px-2 py-1 rounded text-lg cursor-pointer" href="add_ap.php" role="button">Create Sample</a>
        <br>
        <div class="w-full">
        ...
        <td>{$row['status']}</td>
        <td class='px-4 py-2'>
            <a class='bg-green-500 text-white px-2 py-1 rounded text-lg' href='/TNVS_FINANCE/?id={$row['id']}'>Approve</a>
            <a class='bg-red-500 text-white px-2 py-1 rounded text-lg' href='/TNVS_FINANCE/?id={$row['id']}'>Reject</a>
        </td>
                </tr>
                    ";
                }
